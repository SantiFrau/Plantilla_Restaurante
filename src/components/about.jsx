...
export default function About(){
    ...
    return(
        <div className="w-full h-max bg-opacity-40 bg-black" id="about">

            <div className="w-full h-full flex flex-col items-end">
             <div className="md:w-1/2 w-full bg-opacity-80 md:bg-opacity-100 h-max bg-black text-white py-10">
