...
export default function Menu(){
    return(
        <>
        <h3 id="menu" className="relative z-10 fuente text-5xl text-white w-full text-center bg-black py-10 box-shadow-w">Menu</h3>
        <section className=" w-full h-max bg-black flex flex-col items-center justify-center md:flex-row gap-5 p-10 py-10 ">
             {
                menu.map((m,i)=>{
                    return (
                        <div key={i} className="animacion1 hover:scale-110 transition-all relative card flex flex-col gap-3 bg-zinc-900 w-11/12 md:w-1/3 h-max rounded-lg p-3 text-zinc-200">
